...
public class MyRunTest {
	...
	public void checkingBrazilianBundle(){
		...
		assertTrue(bundle.getString(MessageBundle.BODY_ABOUT1).equals("Novos sistemas, modificações e funcionalidades precisam ser implementadas atendendo as necessidades do cliente e não as premissas de tecnologia. Qualidade deve ser a base de tudo e não um diferencial. Mas os modelos de desenvolvimento de software tradicionais não acompanharam as necessidades das empresas, que necessitam de mais agilidade e qualidade."));
		assertTrue(bundle.getString(MessageBundle.BODY_ABOUT2).equals("Pensando nisso, Richard Ferraresi e Aline Borges criaram uma estrutura de atendimento com fábricas e unidades fora do Brasil. Aplicaram conceitos de agilidade, pequenas entregas e muita interação com o cliente, complementadas por testes automatizados e ferramentas de acompanhamento, trazendo melhores resultados em nossas soluções."));
		assertTrue(bundle.getString(MessageBundle.BODY_ABOUT3).equals("É uma fábrica diferente e mod(erna), que acompanha as novas tendências e, acima de tudo, nossa paixão trará uma experiência expecional para você."));
		...
		assertTrue(bundle.getString(MessageBundle.FIG0).equals("Nosso processo de desenvolvimento"));
		...
		assertTrue(bundle.getString(MessageBundle.FIG55).equals("de pensar em software"));
	...
	public void checkingDefaultBundle(){
		...
		//Testing for the display messages inside the About Page
		assertTrue(bundle.getString(MessageBundle.BODY_DISPLAY).equals("It is more than technology, it's our passion"));
		...
		// Testing for the Figure Messages in Service Page
		assertTrue(bundle.getString(MessageBundle.FIG0).equals("Our development process"));
		...
		assertTrue(bundle.getString(MessageBundle.FIG55).equals("thinking about software"));
